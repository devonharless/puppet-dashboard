...
ymax = Math.max(ymax, RGraph.array_sum(obj.data[i]));} else {
...
obj2.Set('chart.labels', []);obj2.Set('chart.background.grid', false);obj2.Set('chart.ylabels', false);obj2.Set('chart.noaxes', true);obj2.Set('chart.title', '');obj2.Set('chart.title.xaxis', '');obj2.Set('chart.title.yaxis', '');obj2.Set('chart.filled.accumulative', obj.Get('chart.filled.accumulative'));obj2.Set('chart.key.shadow', false);obj2.Set('chart.key.position.gutter.boxed', obj.Get('chart.key.position.gutter.boxed'));obj2.Set('chart.key.rounded', obj.Get('chart.key.rounded'));obj2.Draw();obj.Set('chart.line.visible', false);obj.Set('chart.colors', ['rgba(0,0,0,0)']);if(obj.Get('chart.filled')){
